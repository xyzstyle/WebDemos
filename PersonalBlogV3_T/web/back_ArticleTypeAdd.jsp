				...
				<table width="573" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						<td valign="top" align="center">
							...
							<form name="form" method="post" action="articleType.do?method=1"
								...
								<table width="340" border="1" cellpadding="1" cellspacing="1"
									...
									<tr>
										...
										<td width="250" bgcolor="#FFFFFF"><div align="center">
												<input name="typeName" type="text" class="inputinput"
													size="30">
											</div></td>
									</tr>
									<tr>
										...
										<td bgcolor="#FFFFFF"><div align="center">
												<input name="description" type="text" class="inputinput"
													size="30">
											</div></td>
									</tr>
