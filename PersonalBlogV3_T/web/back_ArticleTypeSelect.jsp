...
<jsp:useBean id="articleTypeDao" class="com.xyz.dao.impl.ArticleTypeDaoImpl"
             scope="page"></jsp:useBean>

<%
    String pageNumber = request.getParameter("pageNumber");

    List<ArticleTypeModel> myList = articleTypeDao.queryArticleType();
                ...
                <tr>
                    <td valign="top" align="center">
                        ...
                        <table width="486" border="1" cellpadding="1" cellspacing="1"
                            ...
                            <tr bgcolor="#FFFFFF">
                                <td height="20">
                                    <div align="center"><%=articleTypeModel.getTypeName()%>
                                    </div>
                                </td>
                                <td>
                                    <div align="center"><%=articleTypeModel.getDescription()%>
                                    </div>
                                </td>
                                <td>
                                    <div align="center">
